...
namespace Banhangtaisieuthi
{
    public partial class frmDMNhanVien : Form
    {
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            sql = "INSERT INTO tblNhanVien(MaNhanVien,MK,Quyen,TenNhanVien,GioiTinh, DiaChi,DienThoai,NgaySinh) VALUES (N'" + txtMaNhanVien.Text.Trim() + "',N'" + txtmk.Text.Trim() + "',N'" + cobquyen.SelectedValue + "',N'" + txtTenNhanVien.Text.Trim() + "',N'" + gt + "',N'" + txtDiaChi.Text.Trim() + "','" + mtbDienThoai.Text + "','" + dtpNgaySinh.Value + "')";
            Functions.RunSQL(sql);
            LoadDataGridView();
            ResetValues();
            btnXoa.Enabled = true;
        ...
        private void cobquyen_DropDown(object sender, EventArgs e)
        {
            Functions.FillCombo("SELECT Quyen FROM tblNhanVien", cobquyen, "Quyen", "Quyen");
            cobquyen.SelectedIndex = -1;
        }
